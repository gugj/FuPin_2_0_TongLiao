...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = R.color.green_00cc99;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = R.color.color_999999;
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.ic_select_time_middle_bg);
		}

		if (topShadow == null) {
			//topShadow = new GradientDrawable(Orientation.TOP_BOTTOM, SHADOWS_COLORS);
			topShadow = getContext().getResources().getDrawable(R.drawable.ic_select_time_top_bg);
		}

		if (bottomShadow == null) {
			//bottomShadow = new GradientDrawable(Orientation.BOTTOM_TOP, SHADOWS_COLORS);
			bottomShadow = getContext().getResources().getDrawable(R.drawable.ic_select_time_bottom_bg);
		}
	...
	private void createLayouts(int widthItems, int widthLabel) {
		if (itemsLayout == null || itemsLayout.getWidth() > widthItems) {
			String builed = buildText(isScrollingPerformed);
			itemsLayout = new StaticLayout(builed, itemsPaint, widthItems, widthLabel > 0 ? Layout.Alignment.ALIGN_OPPOSITE : Layout.Alignment.ALIGN_CENTER, 1, ADDITIONAL_ITEM_HEIGHT, false);
		} else {
	...
	private void drawValue(Canvas canvas) {
		valuePaint.setColor(getContext().getResources().getColor(VALUE_TEXT_COLOR));// 
	...
	private void drawItems(Canvas canvas) {
		...
		itemsPaint.setColor(getContext().getResources().getColor(ITEMS_TEXT_COLOR));//  R.color.color_999999
