 ...
 *
 */
public class NoPoorProjectCanLian_JYPX_PXRY_Adapter extends BaseAdapter{

	Context mContext;
	List<ProjectCanlianTrainitemAppModel> list;
	
	/**
	 * 
	 */
	public NoPoorProjectCanLian_JYPX_PXRY_Adapter(Context mContext, List<ProjectCanlianTrainitemAppModel> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (view == null) {
			...
			view = inflater.inflate(R.layout.listview_no_poor_project_canlian_jypx_pxry_list_item, parent, false);
		...
		ProjectCanlianTrainitemAppModel entity = (ProjectCanlianTrainitemAppModel) getItem(position);
		if (entity != null) {
			...
			holder.tv_phone.setText(entity.getPersonphone());
			holder.tv_work_state.setText(entity.getWorkstatusidcall());
			holder.tv_zeren_people.setText(entity.getPersonname());
		}
		return view;
	}
